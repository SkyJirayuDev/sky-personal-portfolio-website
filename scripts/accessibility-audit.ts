...
class AccessibilityAuditor {
  ...
  private checkImageAltAttributes(): string[] {
    ...
    try {
      ...
      const result = execSync('grep -r "img.*src" components/ --include="*.tsx" --include="*.jsx"', { 
        encoding: 'utf8' 
      });
  ...
  private checkHeadingHierarchy(): string[] {
    ...
    try {
      // Check for proper heading hierarchy
      const result = execSync('grep -r "<h[1-6]" components/ --include="*.tsx" --include="*.jsx"', { 
        encoding: 'utf8' 
      });
  ...
  private checkFormLabels(): string[] {
    ...
    try {
      ...
      const inputResult = execSync('grep -r "<input" components/ --include="*.tsx" --include="*.jsx"', { 
        encoding: 'utf8' 
      });
      
      const labelResult = execSync('grep -r "<label" components/ --include="*.tsx" --include="*.jsx"', { 
        encoding: 'utf8' 
      });
