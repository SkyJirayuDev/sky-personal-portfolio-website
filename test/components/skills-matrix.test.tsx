...
describe('SkillsMatrix Component', () => {
  ...
  it('should display proficiency indicators', () => {
    ...
    const reactSkill = screen.getByText('React').closest('[data-testid*="skill"]');
    if (reactSkill) {
  ...
  it('should have responsive grid layout', () => {
    const { container } = render(<SkillsMatrix skillGroups={mockSkillGroups} />);

    // Check for grid or flex layout classes
    const gridContainer = container.querySelector('[class*="grid"], [class*="flex"]');
  ...
  it('should support different display modes if implemented', () => {
    ...
    // Test tags mode
    rerender(
      <SkillsMatrix skillGroups={mockSkillGroups} displayMode="tags" />
    );
    ...
    // Test grid mode
    rerender(
      <SkillsMatrix skillGroups={mockSkillGroups} displayMode="grid" />
    );
